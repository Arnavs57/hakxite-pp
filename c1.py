...
for i in range (100):
    ...
    if c1==1:
        ...
        UNL=input("Enter User Name(minimum length:5 character):")
        EL=input("Enter Email:")
        PWL=input("Create Password(minimum length:8 character):")
        CNL=int(input("Enter a Contact Number: +91"))
        DF1=pd.read_csv("LoginData.csv")
        DF1.loc["0",:]=[UNL,EL,PWL,CNL]
